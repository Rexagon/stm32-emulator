 ...
 */
DEFINE_REG(SysTickControlAndStatusRegister, {
    bool ENABLE : 1;  ///< bit[0]
 ...
 */
DEFINE_REG(SysTickReloadValueRegister, {
 ...
 */
DEFINE_REG(SysTickCurrentValueRegister, {
 ...
 */
DEFINE_REG(SysTickCalibrationValueRegister, {
